...
const SLIDES: Slide[] = [
    {
        icon: 'group',
        title: 'مۆبایل',
        description: 'مۆبایلەکە دەستبەدەست بکەن. پێویستە هەرکەسە و بە تەنیا سەیری شاشەکەی بکات',
        color: '#3B82F6',
    },
    {
        icon: 'lock_open',
        title: 'وشە نهێنییەکە',
        description: 'هەمووان هەمان وشەی نهێنی دەبینن — تەنیا "سیخوڕەکە" نەبێت. سیخوڕەکە نازانێت وشەکە چییە',
        color: '#C0191F',
    },
    {
        icon: 'visibility',
        title: 'گفتوگۆ',
        description: 'هەمووان دەربارەی وشەکە قسە دەکەن، بەڵام پێویستە قسەکانتان ناڕوون بن بۆ ئەوەی وشەکە ئاشکرا نەبێت! سیخوڕەکەش گوێ دەگرێت و هەوڵ دەدات خۆی لە ناو کۆمەڵەکەدا ون بکات و نەکەوێتە گومانەوە',
        color: '#10B981',
    },
    {
        icon: 'fingerprint',
        title: 'دەنگدان',
        description: 'کاتێک کات تەواو بوو، دەنگ بدەن! ئەگەر سیخوڕەکەتان دۆزییەوە — ئێوە دەبەنەوە. ئەگەر نا — ئەوا سیخوڕەکە سەرکەوتوو دەبێت!',
        color: '#F59E0B',
    },
];
